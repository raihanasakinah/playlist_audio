...
class _PageHomeState extends State<PageHome> {
  ...
  Future<ModelAudio> fetchAudio() async {
    final response = await http.get(Uri.parse('http://192.168.120.16/audiodb/audioDB/audio.php'));
          ...
          ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Padding(
                ...
                child: ListTile(
                  leading: Image.network('http://192.168.120.16/audiodb/audioDB/gambar/${filteredData[index].gambar}'),
                  title: Text(
                  ...
                  trailing: Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        onPressed: () {
                          playAudio(filteredData[index].id, 'http://192.168.120.16/audiodb/audioDB/audio/${filteredData[index].fileAudio}');
                        },
                      ),
                      IconButton(
                        icon: Icon(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: NetworkImage('http://192.168.120.16/audiodb/audioDB/gambar/${album.gambar}'),
                fit: BoxFit.cover,
              ),
            ),
          ),
